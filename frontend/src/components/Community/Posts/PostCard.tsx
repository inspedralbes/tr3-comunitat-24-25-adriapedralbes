                    ...
                    <div className="space-y-2">
                        {features.poll.map((option: any) => { // Consider creating a type for 'option'
                            ...
                            return (
                                <div
                                    key={option.id}
                                    className={`relative bg-[#444442] rounded-lg p-2 text-sm text-white hover:bg-[#505050] transition-colors cursor-pointer overflow-hidden ${optionVotes > 0 ? 'border border-blue-500/30' : ''
                                        }`}
                                    onClick={(e) => {
