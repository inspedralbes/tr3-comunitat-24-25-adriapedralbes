            ...
            <div className="flex flex-col sm:flex-row gap-5 mb-8 md:mb-0">
              <Link href="#newsletter-form">
                <div className="w-full sm:w-auto">
                  <RainbowButtonDemo className="px-7 py-3 text-base btn-blink">
                ...
                <div className="flex items-center px-3 py-2 w-full">
                  ...
                  <div className="flex items-center ml-2">
                    ...
                    >
                      {isFullscreen ? (
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M5 4a1 1 0 00-1 1v4a1 1 0 01-2 0V5a3 3 0 013-3h4a1 1 0 010 2H5zm10 8a1 1 0 01-1-1V7a1 1 0 012 0v4a3 3 0 01-3 3h-4a1 1 0 010-2h4a1 1 0 001-1z" clipRule="evenodd" />
                        </svg>
                      ) : (
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
